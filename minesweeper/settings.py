...
SECRET_KEY = '@yryfjxuf@_k6esa8$9)&muu*meb4)38z+=#9fx9v-og-=u^*='
...
INSTALLED_APPS = [
    'minesweeperApp.apps.MinesweeperappConfig',
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'minesweeperApp/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'minesweeperApp/staticfiles'),
]
